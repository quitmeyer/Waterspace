...
void loop() 
{
  ...
  for (int i=0;i<=16-1;i++){
   // strip.setPixelColor(i,Wheel(map(i,0,16-1,30,150)));
  }


  //Scale the input logarithmically instead of linearly
  c = fscale(INPUT_FLOOR, INPUT_CEILING, 150, 0, peakToPeak, 2);
  ...
  if (c <= 16) { // Fill partial column with off pixels
   // drawLine(16, 16-c, strip.Color(0, 0, 0));
  }
 ...
 // strip.setPixelColor(y-1,Wheel(map(y,0,16-1,30,150)));

int intensity = constrain(c+50,0,255);
      drawLine(150, 20, strip.Color(100, intensity,100));
